                                                            ...
                                                            <div class="card border mb-0">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group mb-3 row">
                                                                        ...
                                                                        <div class="col-lg-12 col-xl-12">
                                                                            <div class="input-group">
                                                                                <textarea class="form-control" id="example-textarea" rows="5" spellcheck="false" name="address" id="address" placeholder="Add your address">{{ $profileData->address }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group mb-3 row">
                                                                        ...
                                                                        <div class="col-lg-12 col-xl-12">
                                                                            <div class="input-group">
                                                                                <img src="{{ !empty($profileData->photo) ? url('upload/user_images/'. $profileData->photo) : url('upload/no_image.jpg') }}" alt="" id="showImage" width="100" class="rounded-circle avatar-xxl img-thumbnail float-start">
                                                                            </div>
                                                                        </div>
                                                                    </div>
