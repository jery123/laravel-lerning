            ...
            <x-job-card :job="$application->job">
                <div class="flex items-center justify-between text-xs text-slate-500">
                    <div>
                        ...
                        <div>
                            Other {{ Str::plural('applications', $application->job->job_applications_count) }} {{ $application->job->job_applications_count - 1 }}
                        </div>
                        <div>
                            Your asking salary is ${{ number_format($application->expected_salary) }}
                        </div>
                        <div>
                            Average asking is ${{ number_format($application->job->job_applications_avg_expected_salary) }}
                        </div>
                    </div>
                    <div>
